...
export default function ProjectFinancialsOverviewArticle() {
  return (
    <>
      ...
      <p>
        Project Financials includes eight integrated modules. Click the detailed guides below to learn how to manage
        each workflow:
      </p>

      <h3>1. Arc Books</h3>
      <p>
        Review organization accounting from the ledger and bank activity through statements and period close.
        {" "}
        <Link href="/help/project-financials/financial-workflows/arc-books">
          Read the Arc Books Guide
        </Link>
        .
      </p>
      ...
      <h3>4. Payables</h3>
      <p>
        Manage vendor bills from document review through coding, approval, holds, payment readiness, and accounting follow-through.
        {" "}
      ...
      <h3>8. Purchasing</h3>
      <p>
        Maintain price agreements, resolve PO-generation exceptions before orders are created, and review field variance and completion records.
        {" "}
        <Link href="/help/project-financials/financial-workflows/purchasing">
