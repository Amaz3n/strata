    ...
    <Document>
      <Page size="LETTER" style={styles.page}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Invoice #{data.invoiceNumber} • Issued {data.issuedAtIso}
          </Text>
        ...
        <Text style={styles.small}>
          Generated by Strata. This summary is for convenience and does not replace the executed contract and approved change orders.
        </Text>
      </Page>
    </Document>
  )
