...
export const PROJECT_MODULES = [
  ...
  { key: "photos", label: "Photos", description: "Jobsite photos across project records." },
  ...
  { key: "specs", label: "Specifications", description: "Project manual and spec sections.", postures: ["commercial"] },
  { key: "meetings", label: "Meeting minutes", description: "OAC and project meeting minutes.", postures: ["commercial"] },
  { key: "transmittals", label: "Transmittals", description: "Tracked project document distributions.", postures: ["commercial"] },
  { key: "inspections", label: "Inspections", description: "Safety and quality checklist inspections.", postures: ["commercial"] },
  { key: "safety", label: "Safety", description: "Incidents, toolbox talks, and observations.", postures: ["commercial"] },
