...
import { listSubPortalDailyLogsAction, submitSubPortalDailyLogAction } from "./actions"

export function DailyLogsClient({ token }: { token: string }) {
  ...
  return <div className="space-y-6">
    <form action={submit} className="space-y-4 border border-border bg-card p-4">
