...
import { confirmSubPortalWarrantyVisitAction, completeSubPortalWarrantyVisitAction } from "./actions"
  ...
  if (!visits.length) {
    return (
      <div className="border border-border bg-card px-4 py-12 text-center">
        ...
        <p className="text-sm font-medium">No warranty appointments</p>
        <p className="mt-1 text-sm text-muted-foreground">
          Service visits assigned to your company appear here.
        </p>
      </div>
    )
  }
