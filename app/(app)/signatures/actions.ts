...
export async function getProposalDraftAction(proposalId: string) {
      return await getSourceEntityDraftAction({
...
export async function saveProposalDraftEnvelopeAction(input: {
  ...
  return run(async () => {
      return unwrapAction(await saveDocumentDraftEnvelopeAction({
        document_id: input.document_id,
        source_entity_type: "proposal",
  ...
  return run(async () => {
      ...
      for (const recipient of input.recipients) {
        ...
        try {
          ...
          const sendResult = unwrapAction(await sendDocumentEnvelopeAction({
            document_id: document.id,
            recipients: [
              {
                type: "external_email",
