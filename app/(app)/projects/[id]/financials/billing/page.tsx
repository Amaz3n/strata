...
import { fetchBillingTabDataAction } from "@/app/(app)/projects/[id]/financials/actions"
import { FinancialSetupStatusBanner } from "@/components/financials/financial-setup-status-banner"
import { BillingTab } from "@/components/financials/billing-tab"
...
export default async function FinancialsReceivablesPage({ params, searchParams }: PageProps) {
  ...
  return (
    <Suspense fallback={<FinancialsChildSkeleton title="Billing" />}>
  ...
  return (
    ...
    >
      ...
      <BillingTab
        ...
        invoiceTotalCount={receivablesData.invoiceTotalCount}
        queueCounts={receivablesData.queueCounts}
        draws={draws}
        retainage={retainage}
