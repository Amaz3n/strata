...
import { VendorBillDetailSheet } from "@/components/companies/vendor-bill-detail-sheet";
...
export function CompanyPayables({
  ...
  const [selected, setSelected] = useState<VendorBillSummary | null>(null);
  ...
  const openDetail = (bill: VendorBillSummary) => {
    setSelected(bill);
    setDetailOpen(true);
  };
