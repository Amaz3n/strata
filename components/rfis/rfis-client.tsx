...
const mobileFilterOrder: Array<"all" | StatusKey> = ["all", "draft", "open", "answered", "closed"]
            ...
            {filtered.length === 0 ? (
              ...
              <ul className="divide-y">
                {filtered.map((rfi) => {
                  ...
                  return (
                    <li key={rfi.id} className="flex items-stretch">
                      <button
                        type="button"
                      ...
                      >
                        <span
                          ...
                          className={cn(
                            ...
                            statusDot[rfi.status] ?? "bg-muted-foreground/40",
                          )}
                        />
