...
/// The shared jobsite camera sheet: full-screen capture that falls back to the
/// photo library on a device without a camera, handing back JPEG bytes. Used by
/// receipt scanning and variance-order evidence alike.
struct FieldCameraPicker: UIViewControllerRepresentable {
    ...
    final class Coordinator: NSObject, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
        let parent: FieldCameraPicker
        init(parent: FieldCameraPicker) { self.parent = parent }
