# CONSTRUCTION-04 — Missing sub-tier claimant waiver

Runbook case: `CONSTRUCTION-04`
...
- [ ] A project requiring sub-tier waivers blocks release while any claimant is missing.
