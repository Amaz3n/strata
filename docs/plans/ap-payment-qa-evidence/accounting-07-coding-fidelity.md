# ACCOUNTING-07 — Accounting coding fidelity

Runbook case: `ACCOUNTING-07`
...
- [ ] Fees, retainage, credits, job, vendor, AP account, and expense coding match the provider record.
