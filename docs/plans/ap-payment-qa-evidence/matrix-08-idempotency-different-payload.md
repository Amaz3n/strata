# MATRIX-08 — Same idempotency key and different payload

Runbook case: `MATRIX-08`
...
- [ ] A changed payload under an existing key is rejected and creates no second run.
