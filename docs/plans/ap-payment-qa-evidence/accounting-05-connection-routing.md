# ACCOUNTING-05 — Connection hierarchy routing

Runbook case: `ACCOUNTING-05`
...
- [ ] Project, community, division, and org-default routing each choose the expected accounting file.
