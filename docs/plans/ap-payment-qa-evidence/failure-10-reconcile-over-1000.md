# FAILURE-10 — Reconcile more than 1,000 disbursements

Runbook case: `FAILURE-10`
...
- [ ] Every row is considered and a page boundary cannot produce a false balanced result.
