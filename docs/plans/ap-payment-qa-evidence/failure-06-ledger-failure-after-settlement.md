# FAILURE-06 — Ledger posting fails after settlement

Runbook case: `FAILURE-06`
...
- [ ] Redelivery completes the missing ledger transaction without duplicating payment or settlement.
