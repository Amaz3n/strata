# ACCOUNTING-02 — Provider errors are visible and retryable

Runbook case: `ACCOUNTING-02`
...
- [ ] Both payables surfaces show error or needs_review state and a working retry control.
