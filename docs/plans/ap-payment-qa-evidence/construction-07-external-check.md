# CONSTRUCTION-07 — External check controls

Runbook case: `CONSTRUCTION-07`
...
- [ ] Manual check recording uses the same holds and creates accounting-sync and audit evidence.
