# ACCOUNTING-01 — Bill approval creates sync intent

Runbook case: `ACCOUNTING-01`
...
- [ ] Approval creates one provider-neutral sync record and one deduplicated outbound job.
