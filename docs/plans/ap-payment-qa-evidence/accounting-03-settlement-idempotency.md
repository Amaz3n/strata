# ACCOUNTING-03 — Settlement creates one bill-payment sync

Runbook case: `ACCOUNTING-03`
...
- [ ] Webhook retries still produce one current sync record and one pending outbound job.
