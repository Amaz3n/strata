# CONSTRUCTION-06 — Joint-payee ACH verification

Runbook case: `CONSTRUCTION-06`
...
- [ ] Joint-payee ACH is unavailable unless every destination is verified and bound to the relationship.
