# ACCOUNTING-04 — Expired token backlog replays after reconnect

Runbook case: `ACCOUNTING-04`
...
- [ ] Three settled bill payments all push automatically from the durable backlog after reconnect without individual manual retries.
