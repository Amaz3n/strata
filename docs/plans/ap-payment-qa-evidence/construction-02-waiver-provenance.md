# CONSTRUCTION-02 — Waiver evidence provenance

Runbook case: `CONSTRUCTION-02`
...
- [ ] Evidence includes bill, type, amount, through-date, signed timestamp, file, and signature provenance.
