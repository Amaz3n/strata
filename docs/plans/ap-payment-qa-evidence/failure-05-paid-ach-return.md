# FAILURE-05 — Paid ACH return

Runbook case: `FAILURE-05`
...
- [ ] Arc reopens the bill, records the AP reversal and return loss, disables the mandate, applies the loss ceiling, and opens an exception.
- [ ] A return after transfer but before connected payout reverses or contains the transfer and never pays or reopens the bill twice.
- [ ] A return after payout follows the documented loss/recovery path with exactly one financial reversal.
