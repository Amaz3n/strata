# FAILURE-13 — Builder funding method disabled or updated

Runbook case: `FAILURE-13`
...
- [ ] The funding source and mandate fail closed and a durable operations alert is created.
