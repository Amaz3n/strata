# MATRIX-09 — Two simultaneous runs exceed daily limit

Runbook case: `MATRIX-09`
...
- [ ] Only one execution reservation succeeds and total live reservations remain within the daily limit.
