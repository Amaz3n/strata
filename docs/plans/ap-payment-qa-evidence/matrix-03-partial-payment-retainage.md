# MATRIX-03 — Partial bill payment with retainage held

Runbook case: `MATRIX-03`
...
- [ ] Cash paid equals the approved partial amount net of held retainage, and the remaining bill balance stays open.
