# MATRIX-12 — Concurrent duplicate vendor invoice

Runbook case: `MATRIX-12`
...
- [ ] Canonical invoice identity permits one obligation and rejects the concurrent duplicate.
