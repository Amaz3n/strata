# MATRIX-04 — Signed conditional waiver with valid through-date

Runbook case: `MATRIX-04`
...
- [ ] The signed waiver is linked, current through the covered period, and frozen into approval evidence.
