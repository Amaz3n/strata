# CONSTRUCTION-10 — Canonical duplicate invoice identity

Runbook case: `CONSTRUCTION-10`
...
- [ ] Case, whitespace, and punctuation normalize identically, and duplicate-check failure blocks submission.
