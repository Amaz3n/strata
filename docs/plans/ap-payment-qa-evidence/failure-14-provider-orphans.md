# FAILURE-14 — Provider activity without Arc rows

Runbook case: `FAILURE-14`
...
- [ ] Independent reconciliation creates missing_internal exceptions for payment, transfer, payout, and fee activity.
