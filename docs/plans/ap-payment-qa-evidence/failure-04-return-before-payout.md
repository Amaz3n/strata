# FAILURE-04 — Debit return or cancellation before payout

Runbook case: `FAILURE-04`
...
- [ ] The submission ledger is reversed and no vendor payout is represented as complete.
