# ACCOUNTING-06 — Inbound-only records never push back

Runbook case: `ACCOUNTING-06`
...
- [ ] Imported records remain visible but never create an outbound accounting job.
