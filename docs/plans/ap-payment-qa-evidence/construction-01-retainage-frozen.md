# CONSTRUCTION-01 — Retainage derives from approved bill

Runbook case: `CONSTRUCTION-01`
...
- [ ] The held amount comes from the approved bill and is present in the immutable run item evidence.
