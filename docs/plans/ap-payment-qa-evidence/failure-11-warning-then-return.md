# FAILURE-11 — ACH authorization warning then actual return

Runbook case: `FAILURE-11`
...
- [ ] The warning opens an inquiry without reversing money; the actual return creates exactly one reversal.
