# CONSTRUCTION-09 — Suspended relationship and vendor entity

Runbook case: `CONSTRUCTION-09`
...
- [ ] Submit, approval, retry, and execution all fail before provider submission.
