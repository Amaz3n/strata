# FAILURE-12 — Connected payout fails after transfer

Runbook case: `FAILURE-12`
...
- [ ] The bill is not reopened or paid twice, vendor association remains, and the incident stays open until payout.paid.
- [ ] In a multi-payee run, one payee failure remains independently retryable/actionable while every successful payee remains successful and is never resubmitted.
