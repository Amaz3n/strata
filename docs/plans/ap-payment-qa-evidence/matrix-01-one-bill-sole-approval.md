# MATRIX-01 — One bill, one ACH vendor, sole approval

Runbook case: `MATRIX-01`
...
- [ ] One run pays exactly one approved bill through a verified ACH destination with one approval.
- [ ] The vendor's first invitation click reaches the claim/payment-setup path without an authentication error; an expired invitation shows the recovery/re-invite path rather than a generic 404.
