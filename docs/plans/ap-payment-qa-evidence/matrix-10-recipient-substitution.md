# MATRIX-10 — Client substitutes another recipient UUID

Runbook case: `MATRIX-10`
...
- [ ] The client-provided destination is rejected and no provider submission is created.
