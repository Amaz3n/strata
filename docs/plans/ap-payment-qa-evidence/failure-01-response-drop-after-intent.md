# FAILURE-01 — Response drops after Stripe accepts PaymentIntent

Runbook case: `FAILURE-01`
...
- [ ] Retry adopts the provider intent by idempotency key: one intent, one disbursement, one submitted ledger transaction.
