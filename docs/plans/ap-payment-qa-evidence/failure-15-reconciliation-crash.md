# FAILURE-15 — Reconciliation fails after starting

Runbook case: `FAILURE-15`
...
- [ ] The attempt watermark advances, the success watermark does not, and stale monitoring alerts.
