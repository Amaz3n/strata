# CONSTRUCTION-08 — In-flight bill mutation rejection

Runbook case: `CONSTRUCTION-08`
...
- [ ] Amount, vendor, project, currency, retainage, coding, document, and approval status remain immutable until cancel.
