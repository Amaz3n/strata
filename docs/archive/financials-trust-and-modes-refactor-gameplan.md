...
**Companion plan:** `docs/plans/navigation-scopes-refactor-gameplan.md` (nav/IA refactor). The two can run in parallel EXCEPT: the Financials Summary page (Phase 4.1 here) is referenced by the nav plan — build it here first, or stub the route.
