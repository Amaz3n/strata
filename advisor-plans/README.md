...
These are implementation-oriented product and architecture plans. They are advisory artifacts, not authorization to apply database migrations or change production systems.
