...
-- Historical precursor to 20260725180000_sales_deals.sql. The live ledger
-- stored this statement under version 20260725174233.
...
revoke all on function public.get_sales_deals(uuid, uuid, uuid, boolean, integer) from public, anon;
grant execute on function public.get_sales_deals(uuid, uuid, uuid, boolean, integer) to authenticated, service_role;
