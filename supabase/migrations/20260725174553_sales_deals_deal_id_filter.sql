...
-- Adds the stable deal-id lookup used by the Sales board. The live ledger
-- stored this statement under version 20260725174553.

drop function if exists public.get_sales_deals(uuid, uuid, uuid, boolean, integer);
